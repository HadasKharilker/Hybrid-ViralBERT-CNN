...
Original ViralBERT (Baseline): The original model using BERTweet, RoBERTa, and an MLP classifier.

CNN-Enhanced ViralBERT: Replaced the MLP processing layers with 1D CNN layers.

CNN Classifier Replacement: Fully replaced ViralBERT's MLP classifier with a CNN.

Advanced CNN-Enhanced ViralBERT: An optimized CNN design with skip connections to preserve original feature information.
...
Model 4: Advanced CNN-Enhanced ViralBERT

49.91%

49.71%

Model 5: CNN-Enhanced w/ IndoBERT Preprocessing (Final Method)
...
Rameez, R., et al. (2022). ViralBERT: A user focused BERT-based approach to virality prediction.

Benedecas, H. R. A., & Girsang, A. S. (2024). Virality Prediction on Twitter Using Combined CNN and BERT Models.

Benson, M. (2022). Predicting virality of online news articles using textual content.